  ...
  const dmhyEntries = [
        {day:0, name: '新幹線戰士[12]', link: 'https://share.dmhy.org/topics/list?keyword=新幹線戰士' },
        {day:0, name: '秘密的偶像公主[12]', link: 'https://share.dmhy.org/topics/list?keyword=Himitsu no AiPri' },
        {day:0, name: '戰隊大失格[12]', link: 'https://share.dmhy.org/topics/list?keyword=戰隊大失格' },
        {day:0, name: '夜櫻家大作戰[27]', link: 'https://share.dmhy.org/topics/list?keyword=夜櫻家大作戰' },
        {day:0, name: '吹響吧！上低音號 3', link: 'https://share.dmhy.org/topics/list?keyword=吹響吧！上低音號' },
        {day:0, name: '死神少爺與黑女僕 第三季[36]', link: 'https://share.dmhy.org/topics/list?keyword=死神少爺與黑女僕' },
        {day:0, name: '鬼滅之刃 柱訓練篇[5/12開始]', link: 'https://share.dmhy.org/topics/list?keyword=鬼滅之刃' },
        {day:0, name: '轉生貴族憑鑑定技能扭轉人生[12]', link: 'https://share.dmhy.org/topics/list?keyword=轉生貴族憑鑑定技能扭轉人生' },
        {day:0, name: '老夫老妻重返青春[11]', link: 'https://share.dmhy.org/topics/list?keyword=老夫老妻重返青春' },
        {day:0, name: '吸血鬼男子宿舍[12]', link: 'https://share.dmhy.org/topics/list?keyword=吸血鬼男子宿舍' },
        {day:0, name: '蔚藍檔案 The Animation', link: 'https://share.dmhy.org/topics/list?keyword=蔚藍檔案' },
        {day:0, name: '無職轉生Ⅱ～到了異世界就拿出真本事～ 後半季[24]', link: 'https://share.dmhy.org/topics/list?keyword=無職轉生' },
...
{day:4, name: '她來自煩星 第2季', link: 'https://share.dmhy.org/topics/list?keyword=她來自煩星' },
